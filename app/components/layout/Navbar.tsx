...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Navbar sekarang position:fixed (bukan sticky) supaya tidak lagi
          rawan "putus" gara-gara ancestor lain di halaman - elemen ini
          menggantikan ruang yang tadinya ditempati navbar di alur dokumen. */}
